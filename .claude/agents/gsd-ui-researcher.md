...
Use template from `/Users/torazotokuda/code_testing/spanish_ab_v1/.claude/get-shit-done/templates/UI-SPEC.md`.
...
Read template: `/Users/torazotokuda/code_testing/spanish_ab_v1/.claude/get-shit-done/templates/UI-SPEC.md`
...
```bash
node "/Users/torazotokuda/code_testing/spanish_ab_v1/.claude/get-shit-done/bin/gsd-tools.cjs" commit "docs($PHASE): UI design contract" --files "$PHASE_DIR/$PADDED_PHASE-UI-SPEC.md"
```

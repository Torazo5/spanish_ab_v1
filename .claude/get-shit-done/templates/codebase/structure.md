...
- Usage: Reference from command with `@/Users/torazotokuda/code_testing/spanish_ab_v1/.claude/get-shit-done/workflows/{name}.md`
...
**get-shit-done/**
- Purpose: Resources installed to /Users/torazotokuda/code_testing/spanish_ab_v1/.claude/
- Source: Copied by bin/install.js during installation
- Committed: Yes (source of truth)

**commands/**
- Purpose: Slash commands installed to /Users/torazotokuda/code_testing/spanish_ab_v1/.claude/commands/
- Source: Copied by bin/install.js during installation
- Committed: Yes (source of truth)
